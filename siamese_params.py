...
class Siamese(object):
    _defaults = {
        ...
        #   model_path指向weights/Siamese_weights文件夹下的权值文件
        #-----------------------------------------------------#
        "model_path"        : './weights/Siamese_weights/best_epoch_weights.pth',
        #-----------------------------------------------------#时
        #   输入图片的大小。
        #-----------------------------------------------------#
        "input_shape"       : [224, 224],
    ...
    def detect_image(self, image_1, image_2):
        ...
        plt.text(-12, -12, 'Similarity:%.3f' % output, ha='center', va= 'bottom',fontsize=14)
